...
class GongbiTemplate extends BaseTemplate
{
    ...
    public function execute()
    {
        ...
        $html .= Html::rawElement(
            'div',
            ['id' => 'mw-content-container', 'class' => 'ts-container'],
            Html::rawElement(
                'div',
                ['id' => 'mw-content-block', 'class' => 'ts-inner'],
                Html::rawElement(
                    'div',
                    ['id' => 'mw-content-wrapper'],
                    $this->getContentBlock() .
                        $this->getAfterContent()
                ) .
                    Html::rawElement(
                        'div',
                        ['id' => 'mw-site-navigation'],
                        $this->getLogo('p-logo', 'image') .
                            $this->getMainNavigation()
                    ) .
                    Html::rawElement(
                        'div',
                        ['id' => 'mw-related-navigation'],
    ...
    protected function getSearch()
    {
        ...
        $html .= Html::rawElement(
            'form',
            ['action' => $this->get('wgScript'), 'id' => 'searchform'],
            Html::rawElement(
                'div',
                ['id' => 'simpleSearch'],
                Html::rawElement(
    ...
    protected function getCatList($list, $id, $class, $message)
    {
        ...
        $categoriesHtml = Html::rawElement(
            'ul',
            [],
